...
class NutrientInfoScreen extends StatefulWidget {
  ...
  NutrientInfoScreen(
      {Key? key, this.title,
        this.isDietCategory, this.subTitle,  this.image, this.description, this.ingredient, this.istructions})
      : super(key: key);

  @override NutrientInfoScreenState createState() =>NutrientInfoScreenState();
}
  ...
  Widget build(BuildContext context) {
        ...
        body:  SingleChildScrollView(
            child:  Column(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                          ...
                          child:Padding(
                                  ...
                                  child:SvgPicture.asset("assets/svgs/appbar_leading.svg"),)),

                        Center(child: Image.asset("assets/pngs/food_3.png", fit: BoxFit.fill,
                          height: 235.h,
                          width: 250.w,) ),
                        Align(
                            ...
                            child: Container(
                                ...
                                child: Column(mainAxisAlignment: MainAxisAlignment.start,
                                    ...
                                    children:const <Widget>[
                                       Text("VEGAN DIET", style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w600,
                                          color: kBlack)),

                                       Text("30 days plan", style:  TextStyle(
                                          fontSize: 11,
                      ...
                      Padding(
                          ...
                          child: Column(
                              ...
                              children: <Widget>[
                                ...
                                const Text("Description", style: TextStyle(fontSize: 16,  fontWeight: FontWeight.w600),).addHeight(4),
                                const   Text("Nigerian-inspired, protein-rich vegan egusi stew. Enjoy this with rice, "
                          "yams, plantains, sweet or regular potatoes.").addHeight(12),
                                const  Text("Ingredients", style: TextStyle(fontSize: 16,  fontWeight: FontWeight.w600),).addHeight(4),
                                const Text(
                   ...
                   "1 pack tofu, drained and cubed\n"
                      ...
                      "100g chopped kale or spinach").addHeight(12),
                                const  Text("Instructions", style: TextStyle(fontSize: 16,  fontWeight: FontWeight.w600),).addHeight(4),
                                const  Text("Preheat the oven to 200C. Line a baking tray with baking paper then evenly"
    ...
    "then serve over rice.")]))
      ...
      floatingActionButton: const Padding(
          ...
          child:AppButton(text: "Follow diet plan",
          buttonColor: kPrimary, textColor: kWhite, hasBorder: false)),
