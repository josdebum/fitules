       ...
       // appBar: FituleAppBar(title: 'Sign In',),
        body: SafeArea(child:Padding(
            ...
            AppTextField(
              ...
              borderRadius: 30,
              prefixIcon: SvgPicture.asset("assets/svgs/search.svg", color: kGrey2,),).addHeight(20),
    ...
    child:  TabBar(
            ...
            color: kPrimary,
                 ...
                 Expanded(child: TabBarView(
                      controller: _tabController,
                      children: <Widget>[findFriends(), chatRoom(),notifications()]))
...
Widget findFriends(){
  return ListView.separated( itemCount: 5,
      itemBuilder: (BuildContext context, int index) {
        return ListTile(
            leading: const CircleAvatar(radius: 34, backgroundColor: kWhite,),
            trailing:    Container(
            ...
            title: const Text("Chichi91",  style: TextStyle(color: kBlack, fontSize: 12, fontWeight: FontWeight.w500),));
      },
...
Widget chatRoom(){
  ...
  itemBuilder: (BuildContext context, int index) {
    return const ListTile(
        leading: CircleAvatar(radius: 34, backgroundColor: kWhite,),
        ...
        subtitle: Text("Congratulations!", style: TextStyle(color: kBlack, fontSize: 11, fontWeight: FontWeight.w400),),
        title: Text("Chichi91",  style: TextStyle(color: kBlack, fontSize: 14, fontWeight: FontWeight.w500),));
  },
  separatorBuilder: (BuildContext context, int index) {return const SizedBox(height: 16);});
  ...
  return ListView.separated( itemCount: 5,
    itemBuilder: (BuildContext context, int index) {
      return ListTile(
          ...
          subtitle: const Text("accepted your friend request 5 hours ago", style: TextStyle(color: kBlack, fontSize: 11, fontWeight: FontWeight.w400),),
          title: const Text("Chichi91",  style: TextStyle(color: kBlack, fontSize: 12, fontWeight: FontWeight.w500),));
    },
